...
namespace gate.Conditions
{
    public class EnemiesDeadRemoveObjCondition : ICondition
    {
        ...
        //all enemies dead
        public EnemiesDeadRemoveObjCondition(int id, World world, List<IAiEntity> enemies, List<int> obj_ids_to_remove, Vector2 position, string tag) {
            this.id = id;
            this.world = world;
        ...
        public EnemiesDeadRemoveObjCondition(int id, World world, List<IAiEntity> enemies, List<int> enemy_ids, List<int> obj_ids_to_remove, Vector2 position, string tag) {
            this.id = id;
            this.world = world;
            this.enemies = enemies;
